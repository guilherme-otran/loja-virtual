...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { category: @code.category, description: @code.description, price: @code.price }
    end
  ...
  test "should update code" do
    put :update, id: @code, code: { category: @code.category, description: @code.description, price: @code.price }
    assert_redirected_to code_path(assigns(:code))
  end
